...
public class UsersControllerWebLayerTest {
    ...
    void testCreateUser_whenValidUserDetailsProvided_returnsCreatedUSerDetails() throws Exception {
        ...
        userDetailsRequestModel.setEmail("n@k.com");
        userDetailsRequestModel.setPassword("12345678");
        userDetailsRequestModel.setRepeatPassword("12345678");

        //UserDto userDto = new UserDto();
        //userDto.setFirstName("nish");
       // userDto.setLastName("hey");
        //userDto.setEmail("hi@hi.com");
    ...
    void testCreateUser_whenFirstNameIsNotProvided_thenReturn400StatusCode() throws Exception {
        UserDetailsRequestModel userDetailsRequestModel = new UserDetailsRequestModel();
